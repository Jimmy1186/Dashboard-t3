...
const ChangePasswordTab = ({id,username,oldPassword,setOldPassword,newPassword,setNewPassword,onUpdate}:userType) => {
    ...
    <Tabs defaultValue="tab1">
      ...
      <TabsContent value="tab1">
        ...
        <Fieldset>
          <Label htmlFor="name">員工編號</Label>
          <Input id="name" defaultValue={id} />
        </Fieldset>
        <Fieldset>
      ...
      <TabsContent value="tab2">
        ...
        <Fieldset>
          ...
          <Input id="currentPassword" type="password" value={oldPassword} onChange={(e)=>setOldPassword(e.target.value)}/>
        </Fieldset>
        <Fieldset>
        ...
        <Flex css={{ marginTop: 20, justifyContent: 'flex-end' }}>
          <Button onClick={()=>onUpdate()} variant="green">Change password</Button>
        </Flex>
      </TabsContent>
    </Tabs>
  </Box>
